    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSigninActionPerformed
        ...
        try {
        	...
        	if (username.equals("")||password.equals("")) {
        		JOptionPane.showMessageDialog(EditAcc.this, "All info must be filled!");
        	} else if (getUser().getUsername().equals("sa") && !username.equals("sa")) {
        		JOptionPane.showMessageDialog(EditAcc.this, "You can not change admin name (sa)");
        		txtUsername.setText("sa");
        	} else if (!new UsersDAO().checkUser(u) || username.equals(getUser().getUsername())) {
        		new UsersDAO().editUser(getUser().getUsername(), u);
        		JOptionPane.showMessageDialog(EditAcc.this, "Edit user successfully! Relogin to see change!");
        		dispose();
        	} else {
        		JOptionPane.showMessageDialog(EditAcc.this, "Username already exist!");
        	}
        }catch (Exception ex) {
        	ex.printStackTrace();
        	}
