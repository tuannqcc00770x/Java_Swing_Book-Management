...
public class AddBook extends javax.swing.JDialog {
    ...
    public boolean validBook(Book b)throws Exception {
        ...
        if (!b.getId().matches("[A-Z]{2}[0-9]{4}")) {
        	JOptionPane.showMessageDialog(AddBook.this, "BookID must be 2 letters and 4 numbers. Ex: MB1111", "Alert", JOptionPane.ERROR_MESSAGE);
        	txtBookID.requestFocus();
        	return false;
        }
